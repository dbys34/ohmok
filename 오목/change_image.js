...
board.forEach(function(el){ // el(=element) -> .col로 선택한 각각의 하나의 요소
  el.addEventListener('click', function(event){ //  (event) -> MouseEvent가 들어왔을 때
    console.log(Array.from(el.classList));
    console.log(Array.from(el.parentNode.classList));
    ...
    */
    ...
    locationXY.y = el.parentNode.classList[0].split('-')[1];
